...
![roles](../assets/images/apps/vault/vault_ou_roles.png)
...
![vault-login](../assets/images/apps/vault/vault_oidc_login.png)
...
![portal-page](../assets/images/apps/vault/vault_ou_portal_page.png)
